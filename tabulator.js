...
(function (global, factory) {
    ...
    generate(defaultOptions, userOptions = {}) {
      var output = Object.assign({}, this.registeredDefaults),
        warn =
          ...
          userOptions.debugInvalidOptions === true;
  ...
  class ColumnManager extends CoreFeature {
    ...
    initialize() {
      ...
      this.subscribe(
        "scrollbar-vertical",
        this.padVerticalScrollbar.bind(this)
      );
    }
  ...
  class RowComponent {
    ...
    scrollTo(position, ifVisible) {
      return this._row.table.rowManager.scrollToRow(
        this._row,
        position,
        ifVisible
      );
    ...
    updateData(updatedData) {
      ...
      return new Promise((resolve, reject) => {
        ...
        for (let attrname in updatedData) {
          let columns =
            this.table.columnManager.getColumnsByFieldRoot(attrname);
    ...
    _virtualRenderFill(position, forceMove, offset) {
      ...
      if (rowsCount && Helpers.elVisible(this.elementVertical)) {
        ...
        if (!position) {
          ...
          this.vDomRowHeight = Math.floor(
            (rowsHeight + topPadHeight) / totalRowsRendered
          );
          this.vDomBottomPad =
  ...
  class RowManager extends CoreFeature {
    ...
    initializePlaceholder() {
      ...
      placeholder =
        this.chain("placeholder", [placeholder], placeholder, placeholder) ||
        placeholder;
      ...
      switch (stage) {
        ...
        case "displayPipeline":
          for (let i = index; i < this.displayPipeline.length; i++) {
            ...
            this.setDisplayRows(
              result || this.getDisplayRows(i - 1).slice(0),
              i
            );
          }
  ...
  class Clipboard extends Module {
          ...
          if (!this.blocked) {
            ...
            if (this.customSelection) {
              ...
              if (this.table.options.clipboardCopyFormatter) {
                plain = this.table.options.clipboardCopyFormatter(
                  "plain",
                  plain
                );
              }
    ...
    mutateData(data) {
      ...
      if (Array.isArray(data)) {
        data.forEach((row) => {
          output.push(
            this.table.modules.mutator.transformRow(row, "clipboard")
          );
        });
      } else {
        output = data;
  ...
  class ColumnCalcs extends Module {
    ...
    resizeHolderWidth() {
      this.topElement.style.minWidth =
        this.table.columnManager.headersElement.offsetWidth + "px";
    }
  ...
  function date(cell, onRendered, success, cancel, editorParams) {
    ...
    if (inputFormat) {
      if (DT) {
        ...
        console.error(
          "Editor Error - 'date' editor 'format' param is dependant on luxon.js"
        );
      }
    }
    ...
    input.addEventListener("blur", function (e) {
      if (
        e.relatedTarget ||
        e.rangeParent ||
        e.explicitOriginalTarget !== input
      ) {
  ...
  class Edit$1 extends Module {
    ...
    focusScrollAdjust(cell) {
      if (this.table.rowManager.getRenderMode() == "virtual") {
        ...
        if (this.table.modExists("frozenColumns")) {
          leftEdge += parseInt(
            this.table.modules.frozenColumns.leftMargin || 0
          );
          rightEdge -= parseInt(
            this.table.modules.frozenColumns.rightMargin || 0
          );
        }
        ...
        switch (row.type) {
          case "header":
            headerEl.appendChild(
              this.generateHeaderElement(row, setup, styles)
            );
            break;
  ...
  class Filter extends Module {
    ...
    generatePlaceholder(text) {
      if (
        this.table.options.placeholderHeaderFilter &&
...
<svg class='tabulator-responsive-collapse-toggle-close' viewbox="0 0 24 24">
  ...
  class FrozenColumns extends Module {
    ...
    layoutElement(element, column) {
      ...
      if (column.modules.frozen && element) {
        ...
        if (this.table.rtl) {
          position =
            column.modules.frozen.position === "left" ? "right" : "left";
        } else {
  ...
  class GroupComponent {
    ...
    scrollTo(position, ifVisible) {
      return this._group.groupManager.table.rowManager.scrollToRow(
        this._group,
        position,
        ifVisible
      );
    ...
    initialize() {
      if (this.table.options.persistence) {
        ...
        this.config = {
          ...
          headerFilter:
            this.table.options.persistence === true ||
            this.table.options.persistence.headerFilter,
          group:
            this.table.options.persistence === true ||
        ...
        this.subscribe(
          "filter-changed",
          this.eventSave.bind(this, "headerFilter")
        );
    ...
    initializeColumn(column) {
      ...
      if (def.dblClickPopup && !this.columnSubscribers.dblClickPopup) {
        this.columnSubscribers.dblClickPopup =
          this.loadPopupTableCellEvent.bind(this, "dblClickPopup");
    ...
    initializeColumn(type, component, column, element) {
      ...
      if (
        ...
        if (column.modules.frozen) {
          ...
          handle.style[column.modules.frozen.position] =
