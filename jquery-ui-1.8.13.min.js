...
(function (a, d) {
  ...
  if (!a.ui.version) {
    ...
    a.fn.extend({
      ...
      zIndex: function (g) {
        if (g !== d) return this.css("zIndex", g);
        if (this.length) {
          g = a(this[0]);
    ...
    a.each(["Width", "Height"], function (g, e) {
      function i(l, o, n, k) {
        a.each(b, function () {
          ...
          if (n)
            o -= parseFloat(a.curCSS(l, "border" + this + "Width", true)) || 0;
      ...
      a.fn["inner" + e] = function (l) {
        ...
        return this.each(function () {
          a(this).css(h, i(this, l) + "px");
        });
      };
      a.fn["outer" + e] = function (l, o) {
        if (typeof l !== "number") return j["outer" + e].call(this, l);
        return this.each(function () {
          a(this).css(h, i(this, l, true, o) + "px");
        });
      };
    });
    a.extend(a.expr[":"], {
      ...
      focusable: function (g) {
        return c(g, !isNaN(a.attr(g, "tabindex")));
      },
      tabbable: function (g) {
    ...
    a.extend(a.ui, {
      plugin: {
        add: function (g, e, i) {
          g = a.ui[g].prototype;
          for (var b in i) {
            g.plugins[b] = g.plugins[b] || [];
            g.plugins[b].push([e, i[b]]);
          }
        },
        call: function (g, e, i) {
          if ((e = g.plugins[e]) && g.element[0].parentNode)
            for (var b = 0; b < e.length; b++)
              g.options[e[b][0]] && e[b][1].apply(g.element, i);
        },
      },
      ...
      hasScroll: function (g, e) {
        if (a(g).css("overflow") === "hidden") return false;
      ...
      isOverAxis: function (g, e, i) {
        return g > e && g < e + i;
      },
      isOver: function (g, e, i, b, h, j) {
        return a.ui.isOverAxis(g, i, h) && a.ui.isOverAxis(e, b, j);
      },
    });
  }
})(jQuery);
(function (a, d) {
  if (a.cleanData) {
    ...
    a.cleanData = function (g) {
      for (var e = 0, i; (i = g[e]) != null; e++) a(i).triggerHandler("remove");
      c(g);
    };
  } else {
    var f = a.fn.remove;
    a.fn.remove = function (g, e) {
      return this.each(function () {
        if (!e)
        ...
        return f.call(a(this), g, e);
      });
    };
  }
  a.widget = function (g, e, i) {
    var b = g.split(".")[0],
      h;
    g = g.split(".")[1];
    h = b + "-" + g;
    ...
    e = new e();
    e.options = a.extend(true, {}, e.options);
    a[b][g].prototype = a.extend(
      true,
      e,
      {
        namespace: b,
        widgetName: g,
        widgetEventPrefix: a[b][g].prototype.widgetEventPrefix || g,
        widgetBaseClass: h,
      },
      i
    );
    a.widget.bridge(g, a[b][g]);
  };
  a.widget.bridge = function (g, e) {
    a.fn[g] = function (i) {
      var b = typeof i === "string",
        ...
        j = this;
      i = !b && h.length ? a.extend.apply(null, [true, i].concat(h)) : i;
      if (b && i.charAt(0) === "_") return j;
      b
        ? this.each(function () {
            var l = a.data(this, g),
              o = l && a.isFunction(l[i]) ? l[i].apply(l, h) : l;
            if (o !== l && o !== d) {
              j = o;
              return false;
            }
        ...
        : this.each(function () {
            var l = a.data(this, g);
            l ? l.option(i || {})._init() : a.data(this, g, new e(i, this));
          });
      return j;
    };
  };
  a.Widget = function (g, e) {
    arguments.length && this._createWidget(g, e);
  };
  a.Widget.prototype = {
    widgetName: "widget",
    widgetEventPrefix: "",
    ...
    _trigger: function (g, e, i) {
      var b = this.options[g];
      e = a.Event(e);
      e.type = (
        g === this.widgetEventPrefix ? g : this.widgetEventPrefix + g
      ).toLowerCase();
      i = i || {};
      if (e.originalEvent) {
        ...
        for (var h; g; ) {
          h = a.event.props[--g];
          e[h] = e.originalEvent[h];
        }
      }
      this.element.trigger(e, i);
      return !(
        (a.isFunction(b) && b.call(this.element[0], e, i) === false) ||
  ...
  a.widget("ui.mouse", {
    ...
    _mouseInit: function () {
      ...
      this.element
        ...
        .bind("click." + this.widgetName, function (f) {
          if (true === a.data(f.target, c.widgetName + ".preventClickEvent")) {
            a.removeData(f.target, c.widgetName + ".preventClickEvent");
    ...
    _mouseDown: function (c) {
      if (!d) {
        ...
        var f = this,
          ...
          e =
            typeof this.options.cancel == "string"
              ? a(c.target).parents().add(c.target).filter(this.options.cancel)
                  .length
              : false;
        ...
        true === a.data(c.target, this.widgetName + ".preventClickEvent") &&
          a.removeData(c.target, this.widgetName + ".preventClickEvent");
...
(function (a) {
  a.widget("ui.draggable", a.ui.mouse, {
    ...
    _createHelper: function (d) {
      ...
      d = a.isFunction(c.helper)
        ? a(c.helper.apply(this.element[0], [d]))
        : c.helper == "clone"
    ...
    _getParentOffset: function () {
      ...
      return {
        top:
          d.top + (parseInt(this.offsetParent.css("borderTopWidth"), 10) || 0),
        left:
          d.left +
    ...
    _setContainment: function () {
      ...
      if (d.containment == "document" || d.containment == "window")
        this.containment = [
          (d.containment == "document" ? 0 : a(window).scrollLeft()) -
            this.offset.relative.left -
            this.offset.parent.left,
          (d.containment == "document" ? 0 : a(window).scrollTop()) -
            this.offset.relative.top -
            this.offset.parent.top,
          (d.containment == "document" ? 0 : a(window).scrollLeft()) +
            a(d.containment == "document" ? document : window).width() -
      ...
      if (
        ...
        if (c) {
          ...
          this.containment = [
            ...
            (f ? Math.max(c.scrollWidth, c.offsetWidth) : c.offsetWidth) -
              (parseInt(a(c).css("borderLeftWidth"), 10) || 0) -
              (parseInt(a(c).css("paddingRight"), 10) || 0) -
              this.helperProportions.width -
              this.margins.left -
              this.margins.right,
            (f ? Math.max(c.scrollHeight, c.offsetHeight) : c.offsetHeight) -
              (parseInt(a(c).css("borderTopWidth"), 10) || 0) -
      ...
      if (this.originalPosition) {
        ...
        if (this.containment) {
          if (this.relative_container) {
            ...
            b = [
              this.containment[0] + b.left,
              this.containment[1] + b.top,
              this.containment[2] + b.left,
              this.containment[3] + b.top,
            ];
          } else b = this.containment;
          if (d.pageX - this.offset.click.left < b[0])
            e = b[0] + this.offset.click.left;
          if (d.pageY - this.offset.click.top < b[1])
            i = b[1] + this.offset.click.top;
          if (d.pageX - this.offset.click.left > b[2])
            e = b[2] + this.offset.click.left;
          if (d.pageY - this.offset.click.top > b[3])
            i = b[3] + this.offset.click.top;
        }
        if (c.grid) {
          i =
            this.originalPageY +
            Math.round((i - this.originalPageY) / c.grid[1]) * c.grid[1];
          i = b
            ? !(
                i - this.offset.click.top < b[1] ||
                i - this.offset.click.top > b[3]
              )
              ? i
              : !(i - this.offset.click.top < b[1])
              ? i - c.grid[1]
          ...
          e =
            this.originalPageX +
            Math.round((e - this.originalPageX) / c.grid[0]) * c.grid[0];
          e = b
            ? !(
                e - this.offset.click.left < b[0] ||
                e - this.offset.click.left > b[2]
              )
              ? e
              : !(e - this.offset.click.left < b[0])
              ? e - c.grid[0]
    ...
    _trigger: function (d, c, f) {
      f = f || this._uiHash();
      a.ui.plugin.call(this, d, [c, f]);
      if (d == "drag") this.positionAbs = this._convertPositionTo("absolute");
      return a.Widget.prototype._trigger.call(this, d, c, f);
    },
    plugins: {},
    _uiHash: function () {
      return {
        ...
        if (this.instance._intersectsWith(this.instance.containerCache)) {
          if (!this.instance.isOver) {
            ...
            this.instance.offset.parent.left -=
              f.offset.parent.left - this.instance.offset.parent.left;
            this.instance.offset.parent.top -=
              f.offset.parent.top - this.instance.offset.parent.top;
      ...
      if (
        ...
        if (!f.axis || f.axis != "x")
          if (
            ...
            c.scrollParent[0].scrollTop = g =
              c.scrollParent[0].scrollTop + f.scrollSpeed;
          else if (d.pageY - c.overflowOffset.top < f.scrollSensitivity)
            c.scrollParent[0].scrollTop = g =
              c.scrollParent[0].scrollTop - f.scrollSpeed;
        if (!f.axis || f.axis != "y")
          if (
            ...
            c.scrollParent[0].scrollLeft = g =
              c.scrollParent[0].scrollLeft + f.scrollSpeed;
          else if (d.pageX - c.overflowOffset.left < f.scrollSensitivity)
            c.scrollParent[0].scrollLeft = g =
              c.scrollParent[0].scrollLeft - f.scrollSpeed;
      } else {
        if (!f.axis || f.axis != "x")
  ...
  a.ui.plugin.add("draggable", "snap", {
    start: function () {
      ...
      d.snapElements = [];
      a(
        c.snap.constructor != String
          ? c.snap.items || ":data(draggable)"
          : c.snap
      ).each(function () {
        var f = a(this),
          g = f.offset();
    ...
    drag: function (d, c) {
      for (
        var f = a(this).data("draggable"),
          ...
          e = g.snapTolerance,
          i = c.offset.left,
          b = i + f.helperProportions.width,
          h = c.offset.top,
          j = h + f.helperProportions.height,
          l = f.snapElements.length - 1;
        l >= 0;
        l--
      ) {
        var o = f.snapElements[l].left,
          n = o + f.snapElements[l].width,
          k = f.snapElements[l].top,
          m = k + f.snapElements[l].height;
        if (
          (o - e < i && i < n + e && k - e < h && h < m + e) ||
          (o - e < i && i < n + e && k - e < j && j < m + e) ||
          (o - e < b && b < n + e && k - e < h && h < m + e) ||
          (o - e < b && b < n + e && k - e < j && j < m + e)
        ) {
          if (g.snapMode != "inner") {
            var p = Math.abs(k - j) <= e,
              q = Math.abs(m - h) <= e,
              s = Math.abs(o - b) <= e,
              r = Math.abs(n - i) <= e;
            if (p)
          ...
          if (!f.snapElements[l].snapping && (p || q || s || r || u))
            f.options.snap.snap &&
              f.options.snap.snap.call(
                f.element,
                d,
                a.extend(f._uiHash(), {
                  snapItem: f.snapElements[l].item,
                })
              );
          f.snapElements[l].snapping = p || q || s || r || u;
        } else {
  ...
  a.ui.plugin.add("draggable", "stack", {
    start: function () {
      var d = a(this).data("draggable").options;
      d = a.makeArray(a(d.stack)).sort(function (f, g) {
        return (
...
(function (a) {
  a.widget("ui.droppable", {
    ...
    destroy: function () {
      for (
        var d = a.ui.ddmanager.droppables[this.options.scope], c = 0;
        c < d.length;
        c++
      )
    ...
    _drop: function (d, c) {
      var f = c || a.ui.ddmanager.current;
      ...
      this.element
        ...
        .each(function () {
          ...
          if (
            e.options.greedy &&
            !e.options.disabled &&
            e.options.scope == f.options.scope &&
            e.accept.call(e.element[0], f.currentItem || f.element) &&
            a.ui.intersect(
              f,
              a.extend(e, {
  ...
  a.ui.intersect = function (d, c, f) {
    ...
    var g = (d.positionAbs || d.position.absolute).left,
      ...
      h = c.offset.left,
      j = h + c.proportions.width,
      l = c.offset.top,
      o = l + c.proportions.height;
    switch (f) {
      case "fit":
        return h <= g && e <= j && l <= i && b <= o;
      case "intersect":
        return (
          h < g + d.helperProportions.width / 2 &&
          e - d.helperProportions.width / 2 < j &&
          l < i + d.helperProportions.height / 2 &&
          b - d.helperProportions.height / 2 < o
        );
      case "pointer":
        return a.ui.isOver(
      ...
      case "touch":
        return (
          ((i >= l && i <= o) || (b >= l && b <= o) || (i < l && b > o)) &&
          ((g >= h && g <= j) || (e >= h && e <= j) || (g < h && e > j))
        );
      default:
        return false;
    }
  ...
  a.ui.ddmanager = {
    ...
    prepareOffsets: function (d, c) {
      ...
      a: for (; i < f.length; i++)
        if (
          !(
            f[i].options.disabled ||
            (d &&
              !f[i].accept.call(f[i].element[0], d.currentItem || d.element))
          )
        ) {
          for (var b = 0; b < e.length; b++)
            if (e[b] == f[i].element[0]) {
              f[i].proportions.height = 0;
              continue a;
            }
          f[i].visible = f[i].element.css("display") != "none";
          if (f[i].visible) {
            g == "mousedown" && f[i]._activate.call(f[i], c);
            f[i].offset = f[i].element.offset();
            f[i].proportions = {
              width: f[i].element[0].offsetWidth,
              height: f[i].element[0].offsetHeight,
            };
          }
        }
    },
      ...
      a.each(a.ui.ddmanager.droppables[d.options.scope] || [], function () {
        if (!(this.options.disabled || this.greedyChild || !this.visible)) {
          ...
          if (
            ...
            this[f == "isover" ? "_over" : "_out"].call(this, c);
            if (g && f == "isout") {
              g.isout = 0;
              g.isover = 1;
              g._over.call(g, c);
...
(function (a) {
  a.widget("ui.resizable", a.ui.mouse, {
      ...
      this._renderAxis = function (j) {
        ...
        for (var l in this.handles) {
          if (this.handles[l].constructor == String)
            this.handles[l] = a(this.handles[l], this.element).show();
          if (
    ...
    _mouseCapture: function (f) {
      ...
      for (var e in this.handles)
        if (a(this.handles[e])[0] == f.target) g = true;
    ...
    _mouseStart: function (f) {
      ...
      if (g.containment) {
        e += a(g.containment).scrollLeft() || 0;
        b += a(g.containment).scrollTop() || 0;
      }
    ...
    _mouseDrag: function (f) {
      ...
      if (!i) return false;
      e = i.apply(this, [f, f.pageX - e.left || 0, f.pageY - e.top || 0]);
      if (this._aspectRatio || f.shiftKey) e = this._updateRatio(e, f);
      e = this._respectSize(e, f);
    ...
    _mouseStop: function (f) {
      ...
      if (this._helper) {
        ...
        i = b && a.ui.hasScroll(i[0], "left") ? 0 : e.sizeDiff.height;
        b = b ? 0 : e.sizeDiff.width;
        b = {
          width: e.helper.width() - b,
          height: e.helper.height() - i,
        };
        i =
    ...
    _updateCache: function (f) {
      this.offset = this.helper.offset();
      if (c(f.left)) this.position.left = f.left;
      if (c(f.top)) this.position.top = f.top;
      if (c(f.height)) this.size.height = f.height;
      if (c(f.width)) this.size.width = f.width;
    },
    _updateRatio: function (f) {
      var g = this.position,
        e = this.size,
        i = this.axis;
      if (f.height) f.width = e.height * this.aspectRatio;
      else if (f.width) f.height = e.width / this.aspectRatio;
      if (i == "sw") {
        f.left = g.left + (e.width - f.width);
        f.top = null;
      }
      if (i == "nw") {
        f.top = g.top + (e.height - f.height);
        f.left = g.left + (e.width - f.width);
      }
      return f;
    },
    _respectSize: function (f) {
      var g = this.options,
        e = this.axis,
        i = c(f.width) && g.maxWidth && g.maxWidth < f.width,
        b = c(f.height) && g.maxHeight && g.maxHeight < f.height,
        h = c(f.width) && g.minWidth && g.minWidth > f.width,
        j = c(f.height) && g.minHeight && g.minHeight > f.height;
      if (h) f.width = g.minWidth;
      if (j) f.height = g.minHeight;
      if (i) f.width = g.maxWidth;
      if (b) f.height = g.maxHeight;
      var l = this.originalPosition.left + this.originalSize.width,
        o = this.position.top + this.size.height,
        n = /sw|nw|w/.test(e);
      e = /nw|ne|n/.test(e);
      if (h && n) f.left = l - g.minWidth;
      if (i && n) f.left = l - g.maxWidth;
      if (j && e) f.top = o - g.minHeight;
      if (b && e) f.top = o - g.maxHeight;
    ...
    _proportionallyResize: function () {
      if (this._proportionallyResizeElements.length)
        for (
          ...
          var e = this._proportionallyResizeElements[g];
          if (!this.borderDif) {
            var i = [
            ...
            this.borderDif = a.map(i, function (h, j) {
              h = parseInt(h, 10) || 0;
              j = parseInt(b[j], 10) || 0;
              return h + j;
            });
          ...
          (a.browser.msie &&
            (a(f).is(":hidden") || a(f).parents(":hidden").length)) ||
            e.css({
    ...
    _change: {
      ...
      se: function (f, g, e) {
        return a.extend(
          ...
          this._change.e.apply(this, [f, g, e])
        );
      },
      sw: function (f, g, e) {
        return a.extend(
          this._change.s.apply(this, arguments),
          this._change.w.apply(this, [f, g, e])
        );
      },
      ne: function (f, g, e) {
        return a.extend(
  ...
  a.ui.plugin.add("resizable", "alsoResize", {
    start: function () {
      ...
      if (typeof f.alsoResize == "object" && !f.alsoResize.parentNode)
        if (f.alsoResize.length) {
          ...
          a.each(f.alsoResize, function (e) {
            g(e);
          });
      else g(f.alsoResize);
    },
    resize: function (f, g) {
          ...
          a(l).each(function () {
            var n = a(this),
              ...
              p =
                o && o.length
                  ? o
                  : n.parents(g.originalElement[0]).length
                  ? ["width", "height"]
                  : ["width", "height", "top", "left"];
            a.each(p, function (q, s) {
              if ((q = (k[s] || 0) + (h[s] || 0)) && q >= 0) m[s] = q || null;
            });
      ...
      typeof f.alsoResize == "object" && !f.alsoResize.nodeType
        ? a.each(f.alsoResize, function (l, o) {
            j(l, o);
          })
        : j(f.alsoResize);
    },
    stop: function () {
      ...
      if (f._revertToRelativePosition) {
        ...
        typeof g.alsoResize == "object" && !g.alsoResize.nodeType
          ? a.each(g.alsoResize, function (i) {
              e(i);
            })
          : e(g.alsoResize);
      }
  ...
  a.ui.plugin.add("resizable", "animate", {
    stop: function (f) {
      var g = a(this).data("resizable"),
        e = g.options,
        i = g._proportionallyResizeElements,
        b = i.length && /textarea/i.test(i[0].nodeName),
        h = b && a.ui.hasScroll(i[0], "left") ? 0 : g.sizeDiff.height;
      b = {
        width: g.size.width - (b ? 0 : g.sizeDiff.width),
        height: g.size.height - h,
      };
      h =
  ...
  a.ui.plugin.add("resizable", "containment", {
    start: function () {
      var f = a(this).data("resizable"),
        g = f.element,
        e = f.options.containment;
      if (
        (g =
          e instanceof a ? e.get(0) : /parent/.test(e) ? g.parent().get(0) : e)
      ) {
        ...
        if (/document/.test(e) || e == document) {
          ...
          f.containerOffset = i.offset();
          f.containerPosition = i.position();
          f.containerSize = {
            height: i.innerHeight() - b[3],
            width: i.innerWidth() - b[1],
          };
          e = f.containerOffset;
          var h = f.containerSize.height,
            j = f.containerSize.width;
          j = a.ui.hasScroll(g, "left") ? g.scrollWidth : j;
          h = a.ui.hasScroll(g) ? g.scrollHeight : h;
          f.parentData = {
            element: g,
            left: e.left,
            top: e.top,
    ...
    resize: function (f) {
      ...
      if (j[0] != document && /static/.test(j.css("position"))) h = i;
      if (b.left < (g._helper ? i.left : 0)) {
        g.size.width += g._helper
          ? g.position.left - i.left
          : g.position.left - h.left;
        if (f) g.size.height = g.size.width / e.aspectRatio;
        g.position.left = e.helper ? i.left : 0;
      }
      if (b.top < (g._helper ? i.top : 0)) {
        g.size.height += g._helper ? g.position.top - i.top : g.position.top;
        if (f) g.size.width = g.size.height * e.aspectRatio;
      ...
      e = Math.abs(
        (g._helper ? g.offset.left - h.left : g.offset.left - h.left) +
          g.sizeDiff.width
      );
      i = Math.abs(
        (g._helper ? g.offset.top - h.top : g.offset.top - i.top) +
          g.sizeDiff.height
      );
      b = g.containerElement.get(0) == g.element.parent().get(0);
      h = /relative|absolute/.test(g.containerElement.css("position"));
      if (b && h) e -= g.parentData.left;
      if (e + g.size.width >= g.parentData.width) {
        g.size.width = g.parentData.width - e;
        if (f) g.size.height = g.size.width / g.aspectRatio;
      }
      if (i + g.size.height >= g.parentData.height) {
        g.size.height = g.parentData.height - i;
    ...
    stop: function () {
      var f = a(this).data("resizable"),
        ...
        b = f.containerElement,
        h = a(f.helper),
        j = h.offset(),
        l = h.outerWidth() - f.sizeDiff.width;
      h = h.outerHeight() - f.sizeDiff.height;
      f._helper &&
        !g.animate &&
        /relative/.test(b.css("position")) &&
        a(this).css({
          left: j.left - i.left - e.left,
          width: l,
          height: h,
        });
      f._helper &&
        !g.animate &&
        /static/.test(b.css("position")) &&
        a(this).css({
          left: j.left - i.left - e.left,
          width: l,
          height: h,
  ...
  a.ui.plugin.add("resizable", "grid", {
    resize: function () {
      var f = a(this).data("resizable"),
        ...
        e = f.size,
        i = f.originalSize,
        b = f.originalPosition,
        h = f.axis;
      g.grid = typeof g.grid == "number" ? [g.grid, g.grid] : g.grid;
      var j =
        Math.round((e.width - i.width) / (g.grid[0] || 1)) * (g.grid[0] || 1);
      g =
        Math.round((e.height - i.height) / (g.grid[1] || 1)) * (g.grid[1] || 1);
      if (/^(se|s|e)$/.test(h)) {
        f.size.width = i.width + j;
        f.size.height = i.height + g;
      } else if (/^(ne)$/.test(h)) {
        f.size.width = i.width + j;
        f.size.height = i.height + g;
        f.position.top = b.top - g;
      } else {
        if (/^(sw)$/.test(h)) {
          f.size.width = i.width + j;
          f.size.height = i.height + g;
      ...
      if (!this.options.disabled) {
        ...
        a(d.target)
          ...
          .each(function () {
            var g = a.data(this, "selectable-item");
            if (g) {
              var e = !d.metaKey || !g.$element.hasClass("ui-selected");
              g.$element
        ...
        this.selectees.each(function () {
          ...
          if (!(!j || j.element == c.element[0])) {
            ...
            if (f.tolerance == "touch")
              l = !(j.left > i || j.right < g || j.top > b || j.bottom < e);
            else if (f.tolerance == "fit")
              l = j.left > g && j.right < i && j.top > e && j.bottom < b;
            if (l) {
              if (j.selected) {
...
(function (a) {
  a.widget("ui.sortable", a.ui.mouse, {
    ...
    _mouseCapture: function (d, c) {
      ...
      if (a.data(d.target, "sortable-item") == g) f = a(d.target);
      if (!f) return false;
      if (this.options.handle && !c) {
        var e = false;
        a(this.options.handle, f)
          .find("*")
          .andSelf()
          .each(function () {
    ...
    _mouseDrag: function (d) {
      ...
      if (this.options.scroll) {
        ...
        if (
          ...
          else if (d.pageY - this.overflowOffset.top < c.scrollSensitivity)
            this.scrollParent[0].scrollTop = f =
              this.scrollParent[0].scrollTop - c.scrollSpeed;
          if (
          ...
          else if (d.pageX - this.overflowOffset.left < c.scrollSensitivity)
            this.scrollParent[0].scrollLeft = f =
              this.scrollParent[0].scrollLeft - c.scrollSpeed;
        } else {
          if (d.pageY - a(document).scrollTop() < c.scrollSensitivity)
            f = a(document).scrollTop(a(document).scrollTop() - c.scrollSpeed);
          else if (
            a(window).height() - (d.pageY - a(document).scrollTop()) <
            c.scrollSensitivity
          )
            f = a(document).scrollTop(a(document).scrollTop() + c.scrollSpeed);
          if (d.pageX - a(document).scrollLeft() < c.scrollSensitivity)
      ...
      for (c = this.items.length - 1; c >= 0; c--) {
        ...
        if (e)
          if (
            ...
            this.placeholder[e == 1 ? "next" : "prev"]()[0] != g &&
    ...
    serialize: function (d) {
      ...
      d = d || {};
      a(c).each(function () {
        var g = (a(d.item || this).attr(d.attribute || "id") || "").match(
          d.expression || /(.+)[-=_](.+)/
        );
        if (g)
          f.push(
            (d.key || g[1] + "[]") + "=" + (d.key && d.expression ? g[1] : g[2])
          );
      });
    ...
    _intersectsWith: function (d) {
      var c = this.positionAbs.left,
        f = c + this.helperProportions.width,
      ...
      return this.options.tolerance == "pointer" ||
        ...
        ? l
        : i < c + this.helperProportions.width / 2 &&
            f - this.helperProportions.width / 2 < b &&
            h < g + this.helperProportions.height / 2 &&
            e - this.helperProportions.height / 2 < j;
    },
    ...
    _getItemsAsjQuery: function (d) {
      ...
      if (g && d)
        for (d = g.length - 1; d >= 0; d--)
          for (var e = a(g[d]), i = e.length - 1; i >= 0; i--) {
            var b = a.data(e[i], "sortable");
            if (b && b != this && !b.options.disabled)
              f.push([
                a.isFunction(b.options.items)
                  ? b.options.items.call(b.element)
                  : a(b.options.items, b.element)
    ...
    _removeCurrentsFromItems: function () {
      for (
        var d = this.currentItem.find(":data(sortable-item)"), c = 0;
        c < this.items.length;
        c++
      )
        for (var f = 0; f < d.length; f++)
          d[f] == this.items[c].item[0] && this.items.splice(c, 1);
    },
    _refreshItems: function (d) {
      ...
      if (g)
        for (var e = g.length - 1; e >= 0; e--)
          for (var i = a(g[e]), b = i.length - 1; b >= 0; b--) {
            var h = a.data(i[b], "sortable");
            if (h && h != this && !h.options.disabled) {
              f.push([
                a.isFunction(h.options.items)
                  ? h.options.items.call(h.element[0], d, {
                      item: this.currentItem,
                    })
                  : a(h.options.items, h.element),
                h,
              ]);
    ...
    refreshPositions: function (d) {
      ...
      for (var c = this.items.length - 1; c >= 0; c--) {
        ...
        if (
          ...
          var g = this.options.toleranceElement
            ? a(this.options.toleranceElement, f.item)
            : f.item;
          if (!d) {
      ...
      if (this.options.custom && this.options.custom.refreshContainers)
        ...
        for (c = this.containers.length - 1; c >= 0; c--) {
          g = this.containers[c].element.offset();
          this.containers[c].containerCache.left = g.left;
          this.containers[c].containerCache.top = g.top;
    ...
    _createPlaceholder: function (d) {
      ...
      if (!f.placeholder || f.placeholder.constructor == String) {
        ...
        f.placeholder = {
          element: function () {
            var e = a(document.createElement(c.currentItem[0].nodeName))
              .addClass(
                g || c.currentItem[0].className + " ui-sortable-placeholder"
              )
    ...
    _contactContainers: function (d) {
      ...
      if (c)
        if (this.containers.length === 1) {
          ...
          for (
            var e =
                this.positionAbs[this.containers[f].floating ? "left" : "top"],
            ...
            if (
              ...
              var b =
                this.items[i][this.containers[f].floating ? "left" : "top"];
              if (Math.abs(b - e) < c) {
                c = Math.abs(b - e);
                g = this.items[i];
              }
          ...
          if (g || this.options.dropOnEmpty) {
            ...
            g
              ...
              : this._rearrange(d, null, this.containers[f].element, true);
            this._trigger("change", d, this._uiHash());
    ...
    _createHelper: function (d) {
      var c = this.options;
      d = a.isFunction(c.helper)
        ? a(c.helper.apply(this.element[0], [d, this.currentItem]))
        : c.helper == "clone"
    ...
    _rearrange: function (d, c, f, g) {
      ...
      window.setTimeout(function () {
        i == e.counter && e.refreshPositions(!g);
      }, 0);
    },
    _clear: function (d, c) {
      ...
      if (!a.ui.contains(this.element[0], this.currentItem[0])) {
        ...
        for (g = this.containers.length - 1; g >= 0; g--)
          if (
            a.ui.contains(this.containers[g].element[0], this.currentItem[0]) &&
            !c
          ) {
            f.push(
              function (e) {
...
jQuery.effects ||
  (function (a, d) {
    function c(n) {
      ...
      if ((k = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(n)))
        return [parseInt(k[1], 16), parseInt(k[2], 16), parseInt(k[3], 16)];
      if ((k = /#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(n)))
        return [
          parseInt(k[1] + k[1], 16),
          parseInt(k[2] + k[2], 16),
          parseInt(k[3] + k[3], 16),
    ...
    a.extend(a.effects, {
      ...
      save: function (n, k) {
        for (var m = 0; m < k.length; m++)
          k[m] !== null && n.data("ec.storage." + k[m], n[0].style[k[m]]);
      },
      restore: function (n, k) {
        for (var m = 0; m < k.length; m++)
          k[m] !== null && n.css(k[m], n.data("ec.storage." + k[m]));
      },
    ...
    a.fn.extend({
      ...
      _show: a.fn.show,
      show: function (n) {
        if (h(n)) return this._show.apply(this, arguments);
        else {
          var k = b.apply(this, arguments);
          k[1].mode = "show";
      ...
      _hide: a.fn.hide,
      hide: function (n) {
        if (h(n)) return this._hide.apply(this, arguments);
        else {
          var k = b.apply(this, arguments);
          k[1].mode = "hide";
          return this.effect.apply(this, k);
      ...
      toggle: function (n) {
        if (h(n) || typeof n === "boolean" || a.isFunction(n))
    ...
    a.extend(a.easing, {
      ...
      easeOutElastic: function (n, k, m, p, q) {
        ...
        return (
          r * Math.pow(2, -10 * k) * Math.sin(((k * q - n) * 2 * Math.PI) / s) +
          p +
          m
        );
      },
      ...
      easeInOutBounce: function (n, k, m, p, q) {
        ...
        return (
          a.easing.easeOutBounce(n, k * 2 - q, 0, p, q) * 0.5 + p * 0.5 + m
        );
      },
    });
  })(jQuery);
  ...
  a.effects.blind = function (d) {
    return this.queue(function () {
      var c = a(this),
        ...
        g = a.effects.setMode(c, d.options.mode || "hide"),
        e = d.options.direction || "vertical";
      a.effects.save(c, f);
      c.show();
      var i = a.effects.createWrapper(c).css({
          overflow: "hidden",
        }),
        b = e == "vertical" ? "height" : "width";
      e = e == "vertical" ? i.height() : i.width();
      g == "show" && i.css(b, 0);
      var h = {};
      h[b] = g == "show" ? e : 0;
      i.animate(h, d.duration, d.options.easing, function () {
        g == "hide" && c.hide();
...
(function (a) {
  a.effects.bounce = function (d) {
    return this.queue(function () {
      var c = a(this),
        f = ["position", "top", "bottom", "left", "right"],
        g = a.effects.setMode(c, d.options.mode || "effect"),
        e = d.options.direction || "up",
      ...
      if (g == "show") c.css("opacity", 0).css(j, e == "pos" ? -i : i);
      if (g == "hide") i /= b * 2;
      g != "hide" && b--;
      if (g == "show") {
        var l = {
        ...
        l[j] = (e == "pos" ? "+=" : "-=") + i;
        c.animate(l, h / 2, d.options.easing);
        i /= 2;
        b--;
      }
      for (l = 0; l < b; l++) {
        ...
        o[j] = (e == "pos" ? "-=" : "+=") + i;
        n[j] = (e == "pos" ? "+=" : "-=") + i;
        c.animate(o, h / 2, d.options.easing).animate(
          n,
          h / 2,
          d.options.easing
        );
      ...
      if (g == "hide") {
        ...
        l[j] = (e == "pos" ? "-=" : "+=") + i;
        c.animate(l, h / 2, d.options.easing, function () {
          c.hide();
          a.effects.restore(c, f);
          a.effects.removeWrapper(c);
...
(function (a) {
  a.effects.clip = function (d) {
    return this.queue(function () {
      ...
      if (g == "show") {
        i.css(b.size, 0);
        i.css(b.position, e / 2);
      }
      var h = {};
      h[b.size] = g == "show" ? e : 0;
      h[b.position] = g == "show" ? 0 : e / 2;
      i.animate(h, {
        queue: false,
        duration: d.duration,
...
(function (a) {
  a.effects.drop = function (d) {
    return this.queue(function () {
      ...
      if (g == "show") c.css("opacity", 0).css(i, e == "pos" ? -b : b);
      var h = {
        opacity: g == "show" ? 1 : 0,
      };
      h[i] =
  ...
  a.effects.explode = function (d) {
    return this.queue(function () {
      ...
      var g = a(this).show().css("visibility", "hidden"),
        e = g.offset();
      e.top -= parseInt(g.css("marginTop"), 10) || 0;
      e.left -= parseInt(g.css("marginLeft"), 10) || 0;
      for (
        var i = g.outerWidth(true), b = g.outerHeight(true), h = 0;
        h < c;
        h++
      )
        for (var j = 0; j < f; j++)
          g.clone()
            ...
            .css({
              ...
              left:
                ...
                j * (i / f) +
                (d.options.mode == "show"
                  ? (j - Math.floor(f / 2)) * (i / f)
                  : 0),
              top:
                e.top +
                h * (b / c) +
                (d.options.mode == "show"
                  ? (h - Math.floor(c / 2)) * (b / c)
                  : 0),
...
(function (a) {
  a.effects.fade = function (d) {
    return this.queue(function () {
      var c = a(this),
        f = a.effects.setMode(c, d.options.mode || "hide");
      c.animate(
        {
          opacity: f,
        },
...
(function (a) {
  a.effects.fold = function (d) {
    return this.queue(function () {
      ...
      a.effects.save(c, f);
      c.show();
      var h = a.effects.createWrapper(c).css({
          overflow: "hidden",
        }),
        j = (g == "show") != i,
        l = j ? ["width", "height"] : ["height", "width"];
      j = j ? [h.width(), h.height()] : [h.height(), h.width()];
      var o = /([0-9]+)%/.exec(e);
      if (o) e = (parseInt(o[1], 10) / 100) * j[g == "hide" ? 0 : 1];
      if (g == "show")
        h.css(
          i
            ? {
      ...
      i[l[0]] = g == "show" ? j[0] : e;
      o[l[1]] = g == "show" ? j[1] : 0;
      h.animate(i, b, d.options.easing).animate(
        o,
        b,
        d.options.easing,
        function () {
  ...
  a.effects.highlight = function (d) {
    return this.queue(function () {
      var c = a(this),
        ...
        g = a.effects.setMode(c, d.options.mode || "show"),
        e = {
          backgroundColor: c.css("backgroundColor"),
        };
      if (g == "hide") e.opacity = 0;
      a.effects.save(c, f);
      c.show()
        .css({
...
(function (a) {
  a.effects.pulsate = function (d) {
    return this.queue(function () {
      var c = a(this),
        f = a.effects.setMode(c, d.options.mode || "show");
...
(function (a) {
  ...
  a.effects.scale = function (d) {
    return this.queue(function () {
      var c = a(this),
        f = a.extend(true, {}, d.options),
        g = a.effects.setMode(c, d.options.mode || "effect"),
        e =
          parseInt(d.options.percent, 10) ||
          (parseInt(d.options.percent, 10) == 0 ? 0 : g == "hide" ? 0 : 100),
        i = d.options.direction || "both",
        b = d.options.origin;
      if (g != "effect") {
        f.origin = b || ["middle", "center"];
        f.restore = true;
      }
      b = {
        height: c.height(),
      ...
      c.from =
        ...
        (g == "show"
          ...
          : b);
      e = {
        y: i != "horizontal" ? e / 100 : 1,
        x: i != "vertical" ? e / 100 : 1,
      };
      c.to = {
        height: b.height * e.y,
        width: b.width * e.x,
      ...
      f.to = c.to;
      f.mode = g;
      c.effect("size", f, d.duration, d.callback);
      c.dequeue();
    });
  };
  a.effects.size = function (d) {
    return this.queue(function () {
      ...
      if (o == "box" || o == "both") {
        ...
        if (m.from.x != m.to.x) {
          f = f.concat(h);
          c.from = a.effects.setTransition(c, h, m.from.x, c.from);
          c.to = a.effects.setTransition(c, h, m.to.x, c.to);
        }
      }
      if (o == "content" || o == "both")
        if (m.from.y != m.to.y) {
      ...
      if (o == "content" || o == "both") {
        ...
        e = f.concat(b).concat(h);
        c.find("*[width]").each(function () {
          child = a(this);
          l && a.effects.save(child, e);
          var p = {
            height: child.height(),
            width: child.width(),
          };
          ...
          if (m.from.x != m.to.x) {
            ...
            child.to = a.effects.setTransition(child, h, m.to.x, child.to);
          }
          child.css(child.from);
          child.animate(child.to, d.duration, d.options.easing, function () {
            l && a.effects.restore(child, e);
          });
        });
      }
      c.animate(c.to, {
...
(function (a) {
  a.effects.shake = function (d) {
    return this.queue(function () {
      ...
      l[h] = (j == "pos" ? "+=" : "-=") + e * 2;
      o[h] = (j == "pos" ? "-=" : "+=") + e * 2;
      c.animate(g, b, d.options.easing);
      for (e = 1; e < i; e++)
        c.animate(l, b, d.options.easing).animate(o, b, d.options.easing);
      c.animate(l, b, d.options.easing).animate(
        g,
        b / 2,
        d.options.easing,
        function () {
...
(function (a) {
  a.effects.slide = function (d) {
    return this.queue(function () {
      ...
      if (g == "show") c.css(i, e == "pos" ? (isNaN(b) ? "-" + b : -b) : b);
      var h = {};
      h[i] =
        (g == "show" ? (e == "pos" ? "+=" : "-=") : e == "pos" ? "-=" : "+=") +
        b;
...
(function (a) {
  a.effects.transfer = function (d) {
    return this.queue(function () {
      ...
      g = c.offset();
      var e = a('<div class="ui-effects-transfer"></div>')
...
(function (a) {
  a.widget("ui.accordion", {
    ...
    _create: function () {
      ...
      if (c.navigation) {
        var f = d.element.find("a").filter(c.navigationFilter).eq(0);
        if (f.length) {
    ...
    _keydown: function (d) {
      if (!(this.options.disabled || d.altKey || d.ctrlKey)) {
        ...
        switch (d.keyCode) {
          case c.RIGHT:
          case c.DOWN:
            e = this.headers[(g + 1) % f];
            break;
          case c.LEFT:
          case c.UP:
            e = this.headers[(g - 1 + f) % f];
            break;
          case c.SPACE:
          case c.ENTER:
            this._clickHandler(
    ...
    _clickHandler: function (d, c) {
      ...
      if (!f.disabled)
        if (d.target) {
          ...
          c = d[0] === this.active[0];
          f.active = f.collapsible && c ? false : this.headers.index(d);
          if (!(this.running || (!f.collapsible && c))) {
            var g = this.active;
            h = d.next();
            i = this.active.next();
            b = {
              options: f,
              newHeader: c && f.collapsible ? a([]) : d,
              oldHeader: this.active,
              newContent: c && f.collapsible ? a([]) : h,
              oldContent: i,
            };
            var e =
              this.headers.index(this.active[0]) > this.headers.index(d[0]);
            this.active = c ? a([]) : d;
            this._toggle(h, i, b, c, e);
    ...
    _toggle: function (d, c, f, g, e) {
      ...
      if (b.animated) {
        ...
        b.animated = a.isFunction(b.proxied) ? b.proxied(f) : b.proxied;
        b.duration = a.isFunction(b.proxiedDuration)
          ? b.proxiedDuration(f)
          : b.proxiedDuration;
        g = a.ui.accordion.animations;
        var j = b.duration,
          l = b.animated;
        if (l && !g[l] && !a.easing[l]) l = "slide";
        g[l] ||
          (g[l] = function (o) {
            this.slide(o, {
              easing: l,
      ...
      slide: function (d, c) {
        ...
        if (d.toHide.size())
          if (d.toShow.size()) {
            ...
            a.each(["height", "paddingTop", "paddingBottom"], function (h, j) {
              i[j] = "hide";
              h = ("" + a.css(d.toShow[0], j)).match(/^([\d+-.]+)(.*)$/);
              e[j] = {
                value: h[1],
                unit: h[2] || "px",
              };
              ...
              .animate(i, {
                step: function (h, j) {
                  ...
                  d.toShow[0].style[j.prop] =
                    g * e[j.prop].value + e[j.prop].unit;
                },
                duration: d.duration,
                easing: d.easing,
                complete: function () {
  ...
  a.widget("ui.autocomplete", {
    ...
    _create: function () {
      ...
      this.menu = a("<ul></ul>")
        ...
        .appendTo(a(this.options.appendTo || "body", f)[0])
        .mousedown(function (e) {
          var i = c.menu.element[0];
          a(e.target).closest(".ui-menu-item").length ||
            setTimeout(function () {
              a(document).one("mousedown", function (b) {
                b.target !== c.element[0] &&
                  b.target !== i &&
                  !a.ui.contains(i, b.target) &&
                  c.close();
              });
            }, 1);
          setTimeout(function () {
    ...
    _setOption: function (c, f) {
      ...
      if (c === "appendTo")
        this.menu.element.appendTo(
          a(f || "body", this.element[0].ownerDocument)[0]
        );
    ...
    _initSource: function () {
      ...
      if (a.isArray(this.options.source)) {
        ...
        this.source = function (e, i) {
          i(a.ui.autocomplete.filter(f, e.term));
        };
...
(function (a) {
  a.widget("ui.menu", {
    ...
    activate: function (d, c) {
      this.deactivate();
      if (this.hasScroll()) {
        var f = c.offset().top - this.element.offset().top,
          g = this.element.scrollTop(),
          e = this.element.height();
        if (f < 0) this.element.scrollTop(g + f);
        else f >= e && this.element.scrollTop(g + f - e + c.height());
      }
      this.active = c
        .eq(0)
        .children("a")
    ...
    move: function (d, c, f) {
      if (this.active) {
        ...
        d.length
          ? this.activate(f, d)
          : this.activate(f, this.element.children(c));
      } else this.activate(f, this.element.children(c));
    },
    nextPage: function (d) {
      if (this.hasScroll())
        if (!this.active || this.last())
          ...
          var c = this.active.offset().top,
            ...
            g = this.element.children(".ui-menu-item").filter(function () {
              var e = a(this).offset().top - c - f + a(this).height();
              return e < 10 && e > -10;
            });
      ...
      if (this.hasScroll())
        if (!this.active || this.first())
          ...
          result = this.element.children(".ui-menu-item").filter(function () {
            var g = a(this).offset().top - c + f - a(this).height();
            return g < 10 && g > -10;
          });
          result.length ||
...
(function (a) {
  var d,
    ...
    f = function (g) {
      ...
      if (e)
        b = i
          ? a(i).find("[name='" + e + "']")
          : a("[name='" + e + "']", g.ownerDocument).filter(function () {
              return !this.form;
            });
      return b;
    };
  a.widget("ui.button", {
    ...
    _create: function () {
      ...
      var g = this,
        ...
        b = "ui-state-hover" + (!i ? " ui-state-active" : "");
      ...
      this.buttonElement
        ...
        .bind("mouseleave.button", function () {
          e.disabled || a(this).removeClass(b);
        })
        ...
        .bind("click.button", function (h) {
          e.disabled && h.stopImmediatePropagation();
        });
      i &&
      ...
      if (this.type === "checkbox")
        ...
        this.buttonElement
          ...
          .bind("keydown.button", function (h) {
            if (e.disabled) return false;
            if (
              h.keyCode == a.ui.keyCode.SPACE ||
              h.keyCode == a.ui.keyCode.ENTER
            )
              a(this).addClass("ui-state-active");
          })
        ...
        this.buttonElement.is("a") &&
          this.buttonElement.keyup(function (h) {
            h.keyCode === a.ui.keyCode.SPACE && a(this).click();
          });
      }
    ...
    _determineButtonType: function () {
      ...
      if (this.type === "checkbox" || this.type === "radio") {
        ...
        this.buttonElement = g.find(e);
        if (!this.buttonElement.length) {
          g = g.length ? g.siblings() : this.element.siblings();
          this.buttonElement = g.filter(e);
    ...
    _resetButton: function () {
      if (this.type === "input")
        ...
        var g = this.buttonElement.removeClass(
          ...
          b = i.primary && i.secondary,
          h = [];
        if (i.primary || i.secondary) {
          if (this.options.text)
            h.push(
              "ui-button-text-icon" +
                (b ? "s" : i.primary ? "-primary" : "-secondary")
            );
          i.primary &&
            g.prepend(
          ...
          if (!this.options.text) {
            h.push(b ? "ui-button-icons-only" : "ui-button-icon-only");
            this.hasTitle || g.attr("title", e);
          }
  ...
  a.widget("ui.buttonset", {
    ...
    _setOption: function (g, e) {
      g === "disabled" && this.buttons.button("option", g, e);
      a.Widget.prototype._setOption.apply(this, arguments);
    },
    refresh: function () {
...
(function (a, d) {
  ...
  a.extend(c.prototype, {
    ...
    _connectDatepicker: function (b, h) {
      ...
      if (!j.hasClass(this.markerClassName)) {
        ...
        j.addClass(this.markerClassName)
          .keydown(this._doKeyDown)
          .keypress(this._doKeyPress)
          .keyup(this._doKeyUp)
          .bind("setData.datepicker", function (l, o, n) {
            h.settings[o] = n;
          })
          .bind("getData.datepicker", function (l, o) {
            return this._get(h, o);
          });
        this._autoSize(h);
    ...
    _attachments: function (b, h) {
      ...
      if (j) {
        h.append = a(
          '<span class="' + this._appendClass + '">' + j + "</span>"
        );
      ...
      if (j == "button" || j == "both") {
        ...
        h.trigger = a(
          this._get(h, "buttonImageOnly")
            ? a("<img/>").addClass(this._triggerClass).attr({
                src: o,
                alt: j,
                title: j,
              })
    ...
    _autoSize: function (b) {
      if (this._get(b, "autoSize") && !b.inline) {
        ...
        if (j.match(/[DM]/)) {
          ...
          h.setMonth(
            l(this._get(b, j.match(/MM/) ? "monthNames" : "monthNamesShort"))
          );
          h.setDate(
            l(this._get(b, j.match(/DD/) ? "dayNames" : "dayNamesShort")) +
              20 -
              h.getDay()
          );
        }
    ...
    _enableDatepicker: function (b) {
      ...
      if (h.hasClass(this.markerClassName)) {
        ...
        if (l == "input") {
          ...
          h = h.children("." + this._inlineClass);
    ...
    _disableDatepicker: function (b) {
      ...
      if (h.hasClass(this.markerClassName)) {
        ...
        if (l == "input") {
          ...
          h.find("select.ui-datepicker-month, select.ui-datepicker-year").attr(
            "disabled",
            "disabled"
          );
        }
    ...
    _isDisabledDatepicker: function (b) {
      ...
      for (var h = 0; h < this._disabledInputs.length; h++)
        if (this._disabledInputs[h] == b) return true;
      return false;
    },
    _getInst: function (b) {
      try {
    ...
    _optionDatepicker: function (b, h, j) {
      var l = this._getInst(b);
      if (arguments.length == 2 && typeof h == "string")
        return h == "defaults"
      ...
      if (l) {
        ...
        g(l.settings, o);
        if (k !== null && o.dateFormat !== d && o.minDate === d)
          l.settings.minDate = this._formatDate(l, k);
        if (m !== null && o.dateFormat !== d && o.maxDate === d)
          l.settings.maxDate = this._formatDate(l, m);
    ...
    _changeDatepicker: function (b, h, j) {
      this._optionDatepicker(b, h, j);
    },
    ...
    _getDateDatepicker: function (b, h) {
      (b = this._getInst(b)) && !b.inline && this._setDateFromField(b, h);
      return b ? this._getDate(b) : null;
    },
    _doKeyDown: function (b) {
      var h = a.datepicker._getInst(b.target),
        j = true,
        l = h.dpDiv.is(".ui-datepicker-rtl");
      h._keyEvent = true;
        ...
        switch (b.keyCode) {
          ...
          case 33:
            a.datepicker._adjustDate(
              b.target,
              b.ctrlKey
                ? -a.datepicker._get(h, "stepBigMonths")
                : -a.datepicker._get(h, "stepMonths"),
              "M"
            );
            break;
          case 34:
          ...
          case 37:
            if (b.ctrlKey || b.metaKey)
              a.datepicker._adjustDate(b.target, l ? +1 : -1, "D");
            j = b.ctrlKey || b.metaKey;
    ...
    _doKeyPress: function (b) {
      var h = a.datepicker._getInst(b.target);
      if (a.datepicker._get(h, "constrainInput")) {
        h = a.datepicker._possibleChars(a.datepicker._get(h, "dateFormat"));
    ...
    _showDatepicker: function (b) {
      ...
      if (
        ...
        if (!h.inline) {
          j = a.datepicker._get(h, "showAnim");
          var o = a.datepicker._get(h, "duration"),
            n = function () {
              var k = h.dpDiv.find("iframe.ui-datepicker-cover");
              if (k.length) {
                var m = a.datepicker._getBorders(h.dpDiv);
                k.css({
                  left: -m[0],
                  top: -m[1],
          ...
          a.effects && a.effects[j]
            ? h.dpDiv.show(j, a.datepicker._get(h, "showOptions"), o, n)
            : h.dpDiv[j || "show"](j ? o : null, n);
          if (!j || !o) n();
    ...
    _updateDatepicker: function (b) {
      var h = a.datepicker._getBorders(b.dpDiv);
      i = b;
      ...
      j > 1 &&
        b.dpDiv
          .addClass("ui-datepicker-multi-" + j)
          .css("width", 17 * j + "em");
      b.dpDiv[(h[0] != 1 || h[1] != 1 ? "add" : "remove") + "Class"](
        "ui-datepicker-multi"
      );
    ...
    _getBorders: function (b) {
      ...
      return [
        parseFloat(h(b.css("border-left-width"))),
        parseFloat(h(b.css("border-top-width"))),
      ];
    },
    _checkOffset: function (b, h, j) {
      ...
      h.left -=
        j && h.left == b.input.offset().left ? a(document).scrollLeft() : 0;
      h.top -=
        j && h.top == b.input.offset().top + k ? a(document).scrollTop() : 0;
      h.left -= Math.min(
        h.left,
        h.left + l > m && m > l ? Math.abs(h.left + l - m) : 0
      );
    ...
    _findPos: function (b) {
      for (
        var h = this._get(this._getInst(b), "isRTL");
        b &&
        (b.type == "hidden" || b.nodeType != 1 || a.expr.filters.hidden(b));
    ...
    _hideDatepicker: function (b) {
      var h = this._curInst;
      if (!(!h || (b && h != a.data(b, "datepicker"))))
        if (this._datepickerShowing) {
          b = this._get(h, "showAnim");
          var j = this._get(h, "duration"),
            l = function () {
              a.datepicker._tidyDialog(h);
              this._curInst = null;
            };
          a.effects && a.effects[b]
            ? h.dpDiv.hide(b, a.datepicker._get(h, "showOptions"), j, l)
            : h.dpDiv[
                b == "slideDown"
                  ? "slideUp"
                  : b == "fadeIn"
          ...
          b || l();
          if ((b = this._get(h, "onClose")))
            b.apply(h.input ? h.input[0] : null, [
              h.input ? h.input.val() : "",
              h,
            ]);
    ...
    _checkExternalClick: function (b) {
      if (a.datepicker._curInst) {
        ...
        b[0].id != a.datepicker._mainDivId &&
          b.parents("#" + a.datepicker._mainDivId).length == 0 &&
          !b.hasClass(a.datepicker.markerClassName) &&
          !b.hasClass(a.datepicker._triggerClass) &&
          a.datepicker._datepickerShowing &&
          !(a.datepicker._inDialog && a.blockUI) &&
          a.datepicker._hideDatepicker();
      }
    },
    _adjustDate: function (b, h, j) {
      b = a(b);
      var l = this._getInst(b[0]);
      if (!this._isDisabledDatepicker(b[0])) {
        this._adjustInstDate(
          l,
          h + (j == "M" ? this._get(l, "showCurrentAtPos") : 0),
          j
        );
        this._updateDatepicker(l);
      }
    ...
    _selectMonthYear: function (b, h, j) {
      b = a(b);
      var l = this._getInst(b[0]);
      l._selectingMonthYear = false;
      l["selected" + (j == "M" ? "Month" : "Year")] = l[
        "draw" + (j == "M" ? "Month" : "Year")
      ] = parseInt(h.options[h.selectedIndex].value, 10);
      this._notifyChange(l);
      this._adjustDate(b);
    },
    _clickMonthYear: function (b) {
      var h = this._getInst(a(b)[0]);
      h.input &&
        h._selectingMonthYear &&
        setTimeout(function () {
          h.input.focus();
        }, 0);
      h._selectingMonthYear = !h._selectingMonthYear;
    },
    _selectDay: function (b, h, j, l) {
      var o = a(b);
      if (
        !(
          a(l).hasClass(this._unselectableClass) ||
    ...
    iso8601Week: function (b) {
      ...
      b.setMonth(0);
      b.setDate(1);
      return Math.floor(Math.round((h - b) / 864e5) / 7) + 1;
    },
    parseDate: function (b, h, j) {
      if (b == null || h == null) throw "Invalid arguments";
      ...
      for (
        var o = (j ? j.dayNamesShort : null) || this._defaults.dayNamesShort,
          n = (j ? j.dayNames : null) || this._defaults.dayNames,
          k = (j ? j.monthNamesShort : null) || this._defaults.monthNamesShort,
          m = (j ? j.monthNames : null) || this._defaults.monthNames,
          p = (j = -1),
          q = -1,
          s = -1,
          r = false,
          u = function (y) {
            (y = G + 1 < b.length && b.charAt(G + 1) == y) && G++;
            return y;
          },
          v = function (y) {
            var H = u(y);
          ...
          w = function (y, H, N) {
            ...
            var J = -1;
            a.each(y, function (D, E) {
              D = E[1];
              if (h.substr(z, D.length).toLowerCase() == D.toLowerCase()) {
                J = E[0];
                z += D.length;
                return false;
              }
      ...
      if (C.getFullYear() != j || C.getMonth() + 1 != p || C.getDate() != q)
        throw "Invalid date";
      return C;
    },
    ATOM: "yy-mm-dd",
          ...
          if (s)
            ...
            switch (b.charAt(r)) {
              ...
              case "o":
                q += m(
                  "o",
                  (h.getTime() - new Date(h.getFullYear(), 0, 0).getTime()) /
                    864e5,
                  3
                );
                break;
              case "m":
                q += m("m", h.getMonth() + 1, 2);
                break;
              case "M":
                q += p("M", h.getMonth(), n, j);
                break;
              case "y":
                q += k("y")
                  ? h.getFullYear()
    ...
    _get: function (b, h) {
      return b.settings[h] !== d ? b.settings[h] : this._defaults[h];
    },
    ...
    _getDefaultDate: function (b) {
      return this._restrictMinMax(
        b,
        this._determineDate(b, this._get(b, "defaultDate"), new Date())
      );
    },
    _determineDate: function (b, h, j) {
      var l = function (n) {
          var k = new Date();
        ...
        o = function (n) {
          ...
          var m =
              (n.toLowerCase().match(/^c/) ? a.datepicker._getDate(b) : null) ||
              new Date(),
            p = m.getFullYear(),
            q = m.getMonth();
          m = m.getDate();
          for (
            var s = /([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, r = s.exec(n);
            r;
          ...
          (h =
            h == null || h === ""
              ...
              ? isNaN(h)
                ? j
                : l(h)
              : new Date(h.getTime())) && h.toString() == "Invalid Date"
            ? j
            : h)
      ) {
        h.setHours(0);
    ...
    _setDate: function (b, h, j) {
      ...
      if ((o != b.selectedMonth || n != b.selectedYear) && !j)
    ...
    _generateHTML: function (b) {
      ...
      if (u) {
        var w = this._daylightSavingAdjust(
          new Date(u.getFullYear(), u.getMonth() - k[0] * k[1] + 1, u.getDate())
        );
        for (
          w = r && w < r ? r : w;
      ...
      w = !n
        ...
        : this.formatDate(
            w,
            this._daylightSavingAdjust(new Date(v, m - p, 1)),
            this._getFormatConfig(b)
          );
      w = this._canAdjustMonth(b, -1, v, m)
      ...
      o = this._canAdjustMonth(b, +1, v, m)
      ...
      for (var J = this._getDefaultDate(b), D = "", E = 0; E < k[0]; E++) {
        for (var P = "", L = 0; L < k[1]; L++) {
          ...
          F +=
            ...
            B +
            '">' +
            (/all|left/.test(B) && E == 0 ? (j ? o : w) : "") +
            (/all|right/.test(B) && E == 0 ? (j ? w : o) : "") +
            this._generateMonthYearHeader(b, m, v, r, u, E > 0 || L > 0, G, C) +
          ...
          for (B = 0; B < 7; B++) {
            ...
            I +=
              "<th" +
              ((B + n + 6) % 7 >= 5 ? ' class="ui-datepicker-week-end"' : "") +
              '><span title="' +
              x[A] +
              '">' +
              z[A] +
          ...
          if (v == b.selectedYear && m == b.selectedMonth)
            b.selectedDay = Math.min(b.selectedDay, I);
          ...
          for (var R = 0; R < I; R++) {
            ...
            var S = !p
              ...
              : '<td class="ui-datepicker-week-col">' +
                this._get(b, "calculateWeek")(A) +
                "</td>";
            for (B = 0; B < 7; B++) {
              var M = y
                  ? y.apply(b.input ? b.input[0] : null, [A])
                  : [true, ""],
                K = A.getMonth() != m,
                O = (K && !N) || !M[0] || (r && A < r) || (u && A > u);
              S +=
                '<td class="' +
                ((B + n + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") +
                (K ? " ui-datepicker-other-month" : "") +
                ((A.getTime() == Q.getTime() &&
                  m == b.selectedMonth &&
                  b._keyEvent) ||
                (J.getTime() == A.getTime() && J.getTime() == Q.getTime())
                  ? " " + this._dayOverClass
                  : "") +
                (O
                ...
                (K && !H
                  ...
                  : '<a class="ui-state-default' +
                    (A.getTime() == h.getTime() ? " ui-state-highlight" : "") +
                    (A.getTime() == s.getTime() ? " ui-state-active" : "") +
      ...
      D +=
        l +
        (a.browser.msie && parseInt(a.browser.version, 10) < 7 && !b.inline
    ...
    _generateMonthYearHeader: function (b, h, j, l, o, n, k, m) {
      ...
      if (n || !p) u += '<span class="ui-datepicker-month">' + k[h] + "</span>";
        ...
        u +=
          ...
          "');\">";
        for (var w = 0; w < 12; w++)
          if ((!k || w >= l.getMonth()) && (!v || w <= o.getMonth()))
            u +=
              '<option value="' +
              w +
              '"' +
    ...
    _adjustInstDate: function (b, h, j) {
      var l = b.drawYear + (j == "Y" ? h : 0),
        o = b.drawMonth + (j == "M" ? h : 0);
      h =
        Math.min(b.selectedDay, this._getDaysInMonth(l, o)) +
        (j == "D" ? h : 0);
      l = this._restrictMinMax(
        b,
        this._daylightSavingAdjust(new Date(l, o, h))
      );
    ...
    _notifyChange: function (b) {
      ...
      if (h)
        h.apply(b.input ? b.input[0] : null, [
          b.selectedYear,
          b.selectedMonth + 1,
          b,
        ]);
    ...
    _canAdjustMonth: function (b, h, j, l) {
      var o = this._getNumberOfMonths(b);
      j = this._daylightSavingAdjust(
        new Date(j, l + (h < 0 ? h : o[0] * o[1]), 1)
      );
    ...
    _isInRange: function (b, h) {
      ...
      b = this._getMinMaxDate(b, "max");
      return (
        (!j || h.getTime() >= j.getTime()) && (!b || h.getTime() <= b.getTime())
      );
    },
    _getFormatConfig: function (b) {
      var h = this._get(b, "shortYearCutoff");
      h =
        typeof h != "string"
          ? h
    ...
    _formatDate: function (b, h, j, l) {
      ...
      h = h
        ? typeof h == "object"
          ? h
          : this._daylightSavingAdjust(new Date(l, j, h))
        : this._daylightSavingAdjust(
            new Date(b.currentYear, b.currentMonth, b.currentDay)
          );
      return this.formatDate(
        this._get(b, "dateFormat"),
        h,
        this._getFormatConfig(b)
      );
    },
  ...
  a.fn.datepicker = function (b) {
    ...
    if (!a.datepicker.initialized) {
      a(document)
        .mousedown(a.datepicker._checkExternalClick)
        .find("body")
        .append(a.datepicker.dpDiv);
    ...
    if (
      ...
      return a.datepicker["_" + b + "Datepicker"].apply(
        a.datepicker,
        [this[0]].concat(h)
      );
    if (
...
(function (a, d) {
  ...
  a.widget("ui.dialog", {
    ...
    _create: function () {
      ...
      var e = this,
        i = e.options,
        b = i.title || "&#160;",
        h = a.ui.dialog.getTitleId(e.element),
        j = (e.uiDialog = a("<div></div>"))
          .appendTo(document.body)
          .hide()
          .addClass(
      ...
      e.element
        ...
        .appendTo(j);
      var l = (e.uiDialogTitlebar = a("<div></div>"))
          .addClass(
        ...
        o = a('<a href="#"></a>')
          ...
          .appendTo(l);
      (e.uiDialogTitlebarCloseText = a("<span></span>"))
    ...
    close: function (e) {
      var i = this,
        b,
        h;
      if (false !== i._trigger("beforeClose", e)) {
    ...
    open: function () {
      if (!this._isOpen) {
        var e = this,
          i = e.options,
          b = e.uiDialog;
        e.overlay = i.modal ? new a.ui.dialog.overlay(e) : null;
        e._size();
        e._position(i.position);
        b.show(i.show);
        e.moveToTop(true);
        i.modal &&
          b.bind("keypress.ui-dialog", function (h) {
        ...
        a(
          e.element
            ...
            .get()
            .concat(
              b.find(".ui-dialog-buttonpane :tabbable").get().concat(b.get())
            )
        )
          .eq(0)
          .focus();
      ...
      if (b) {
        a.each(e, function (l, o) {
          o = a.isFunction(o)
            ...
            : o;
          var n = a('<button type="button"></button>')
            .click(function () {
              o.click.apply(i.element[0], arguments);
            })
            .appendTo(j);
          a.each(o, function (k, m) {
            if (k !== "click") k in g ? n[k](m) : n.attr(k, m);
          });
    ...
    _makeDraggable: function () {
      ...
      i.uiDialog.draggable({
        ...
        start: function (l, o) {
          ...
          i._trigger("dragStart", l, e(o));
        },
        drag: function (l, o) {
          i._trigger("drag", l, e(o));
        },
        stop: function (l, o) {
          b.position = [
            o.position.left - h.scrollLeft(),
            o.position.top - h.scrollTop(),
          ];
          a(this).removeClass("ui-dialog-dragging").height(j);
          i._trigger("dragStop", l, e(o));
          a.ui.dialog.overlay.resize();
        },
      });
    },
    _makeResizable: function (e) {
      ...
      e = e === d ? this.options.resizable : e;
      var b = this,
        h = b.options,
    ...
    _position: function (e) {
      ...
      } else e = a.ui.dialog.prototype.options.position;
    ...
    _setOptions: function (e) {
      ...
      this.uiDialog.is(":data(resizable)") &&
        this.uiDialog.resizable("option", b);
    },
    _setOption: function (e, i) {
      ...
      switch (e) {
        ...
        case "closeText":
          ...
          break;
        case "dialogClass":
          h.removeClass(b.options.dialogClass).addClass(
        ...
        case "position":
          ...
          break;
        case "resizable":
          (j = h.is(":data(resizable)")) && !i && h.resizable("destroy");
          j && typeof i === "string" && h.resizable("option", "handles", i);
    ...
    _size: function () {
      ...
      if (e.height === "auto")
        if (a.support.minHeight)
          ...
          h || this.uiDialog.hide();
          this.element.height(Math.max(e, b));
        }
      else this.element.height(Math.max(e.height - i, 0));
      this.uiDialog.is(":data(resizable)") &&
  ...
  a.extend(a.ui.dialog.overlay, {
    ...
    destroy: function (e) {
      var i = a.inArray(e, this.instances);
    ...
    height: function () {
      ...
      if (a.browser.msie && a.browser.version < 7) {
        ...
        return e < i ? a(window).height() + "px" : e + "px";
    ...
    width: function () {
      ...
      if (a.browser.msie && a.browser.version < 7) {
        ...
        return e < i ? a(window).width() + "px" : e + "px";
...
(function (a) {
  ...
  a.fn.position = function (e) {
    ...
    if (e.at[0] === "right") n.left += l;
    else if (e.at[0] === "center") n.left += l / 2;
    if (e.at[1] === "bottom") n.top += o;
    else if (e.at[1] === "center") n.top += o / 2;
    n.left += j[0];
    n.top += j[1];
    return this.each(function () {
      var k = a(this),
        ...
        v = a.extend({}, n),
        w;
      if (e.my[0] === "right") v.left -= m;
      else if (e.my[0] === "center") v.left -= m / 2;
      if (e.my[1] === "bottom") v.top -= p;
      else if (e.my[1] === "center") v.top -= p / 2;
      ...
      a.each(["left", "top"], function (x, z) {
        a.ui.position[h[x]] &&
          a.ui.position[h[x]][z](v, {
            targetWidth: l,
            targetHeight: o,
            elemWidth: m,
            elemHeight: p,
    ...
    fit: {
      ...
      top: function (e, i) {
        ...
        b =
          ...
          b.scrollTop();
        e.top =
          b > 0 ? e.top - b : Math.max(e.top - i.collisionPosition.top, e.top);
      },
    },
    flip: {
      left: function (e, i) {
      ...
      top: function (e, i) {
        if (i.at[1] !== "center") {
          ...
          var h =
            ...
            l = -2 * i.offset[1];
          e.top +=
            i.collisionPosition.top < 0 ? h + j + l : b > 0 ? h + j + l : 0;
        }
      },
    },
  };
  if (!a.offset.setOffset) {
    a.offset.setOffset = function (e, i) {
      if (/static/.test(a.curCSS(e, "position"))) e.style.position = "relative";
      var b = a(e),
        h = b.offset(),
        j = parseInt(a.curCSS(e, "top", true), 10) || 0,
        l = parseInt(a.curCSS(e, "left", true), 10) || 0;
      h = {
        top: i.top - h.top + j,
        left: i.left - h.left + l,
      };
      "using" in i ? i.using.call(e, h) : b.css(h);
    };
...
(function (a) {
  a.widget("ui.slider", a.ui.mouse, {
    ...
    _create: function () {
      ...
      this.element.addClass(
        "ui-slider ui-slider-" +
          ...
          (c.disabled ? " ui-slider-disabled ui-disabled" : "")
      );
      this.range = a([]);
      if (c.range) {
        if (c.range === true) {
      ...
      for (var i = f.length; i < g; i += 1)
        e.push(
          "<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'></a>"
        );
      this.handles = f.add(a(e.join("")).appendTo(d.element));
    ...
    _mouseCapture: function (d) {
      ...
      this.handles.hasClass("ui-state-hover") || this._slide(d, b, f);
    ...
    _values: function (d) {
      ...
      if (arguments.length) {
        ...
        for (f = 0; f < c.length; f += 1) c[f] = this._trimAlignValue(c[f]);
        return c;
      }
    },
    _trimAlignValue: function (d) {
      ...
      var c = this.options.step > 0 ? this.options.step : 1,
        f = (d - this._valueMin()) % c;
      alignValue = d - f;
      if (Math.abs(f) * 2 >= c) alignValue += f > 0 ? c : -c;
    ...
    _refreshValue: function () {
      var d = this.options.range,
        c = this.options,
        f = this,
        g = !this._animateOff ? c.animate : false,
        e,
        i = {},
        b,
        h,
      ...
      if (this.options.values && this.options.values.length)
        this.handles.each(function (o) {
          e =
            ((f.values(o) - f._valueMin()) / (f._valueMax() - f._valueMin())) *
            100;
          i[f.orientation === "horizontal" ? "left" : "bottom"] = e + "%";
          a(this).stop(1, 1)[g ? "animate" : "css"](i, c.animate);
        ...
        e = l !== j ? ((h - j) / (l - j)) * 100 : 0;
        i[f.orientation === "horizontal" ? "left" : "bottom"] = e + "%";
        this.handle.stop(1, 1)[g ? "animate" : "css"](i, c.animate);
...
(function (a, d) {
  ...
  a.widget("ui.tabs", {
    ...
    _setOption: function (i, b) {
      if (i == "selected")
        (this.options.collapsible && b == this.options.selected) ||
          this.select(b);
      else {
        this.options[i] = b;
        this._tabify();
    ...
    _tabId: function (i) {
      return (
        (i.title &&
          i.title.replace(/\s/g, "_").replace(/[^\w\u00c0-\uFFFF-]/g, "")) ||
        this.options.idPrefix + c()
      );
    },
    ...
    _tabify: function (i) {
      ...
      this.anchors.each(function (r, u) {
        ...
        if (l.test(v))
          h.panels = h.panels.add(h.element.find(h._sanitizeSelector(v)));
        else if (v && v !== "#") {
          ...
          if (!u.length) {
            u = a(j.panelTemplate)
              ...
              .insertAfter(h.panels[r - 1] || h.list);
            u.data("destroy.tabs", true);
          }
          h.panels = h.panels.add(u);
      ...
      if (i) {
        ...
        if (j.selected === d) {
          ...
          if (typeof j.selected !== "number" && j.cookie)
            j.selected = parseInt(h._cookie(), 10);
          if (
        ...
        j.disabled = a
          .unique(
            j.disabled.concat(
              a.map(this.lis.filter(".ui-state-disabled"), function (r) {
                return h.lis.index(r);
              })
            )
          )
          .sort();
        a.inArray(j.selected, j.disabled) != -1 &&
          j.disabled.splice(a.inArray(j.selected, j.disabled), 1);
        this.panels.addClass("ui-tabs-hide");
        this.lis.removeClass("ui-tabs-selected ui-state-active");
        if (j.selected >= 0 && this.anchors.length) {
          h.element
            .find(h._sanitizeSelector(h.anchors[j.selected].hash))
          ...
          h.element.queue("tabs", function () {
            h._trigger(
              ...
              null,
              h._ui(
                h.anchors[j.selected],
                h.element.find(
                  h._sanitizeSelector(h.anchors[j.selected].hash)
                )[0]
              )
            );
          });
      ...
      i = 0;
      for (var o; (o = this.lis[i]); i++)
        a(o)[
          a.inArray(i, j.disabled) != -1 && !a(o).hasClass("ui-tabs-selected")
            ? "addClass"
            : "removeClass"
        ]("ui-state-disabled");
          ...
          ? function (r, u) {
              ...
              u.hide()
                ...
                .animate(p, p.duration || "normal", function () {
                  b(u, p);
                  h._trigger("show", null, h._ui(r, u[0]));
                });
            }
          : function (r, u) {
              a(r).closest("li").addClass("ui-tabs-selected ui-state-active");
      ...
      this.anchors.bind(j.event + ".tabs", function () {
        var r = this,
          u = a(r).closest("li"),
          v = h.panels.filter(":not(.ui-tabs-hide)"),
          w = h.element.find(h._sanitizeSelector(r.hash));
        if (
          (u.hasClass("ui-tabs-selected") && !j.collapsible) ||
          u.hasClass("ui-state-disabled") ||
          u.hasClass("ui-state-processing") ||
          h.panels.filter(":animated").length ||
          h._trigger("select", null, h._ui(this, w[0])) === false
        ) {
          this.blur();
          return false;
        }
        j.selected = h.anchors.index(this);
        h.abort();
        if (j.collapsible)
          if (u.hasClass("ui-tabs-selected")) {
            j.selected = -1;
            j.cookie && h._cookie(j.selected, j.cookie);
            h.element
              .queue("tabs", function () {
                s(r, v);
              })
    ...
    _getIndex: function (i) {
      if (typeof i == "string")
        i = this.anchors.index(this.anchors.filter("[href$=" + i + "]"));
      return i;
    },
    destroy: function () {
      var i = this.options;
    ...
    add: function (i, b, h) {
      ...
      o.length ||
        (o = a(l.panelTemplate).attr("id", i).data("destroy.tabs", true));
      o.addClass(
    ...
    enable: function (i) {
      ...
      if (a.inArray(i, b.disabled) != -1) {
        ...
        b.disabled = a.grep(b.disabled, function (h) {
          return h != i;
        });
        this._trigger(
          "enable",
    ...
    load: function (i) {
      ...
      if (
        !l ||
        (this.element.queue("tabs").length !== 0 && a.data(j, "cache.tabs"))
      )
        ...
        if (h.spinner) {
          var o = a("span", j);
          o.data("label.tabs", o.html()).html(h.spinner);
        }
        this.xhr = a.ajax(
          a.extend({}, h.ajaxOptions, {
            url: l,
            success: function (n, k) {
              b.element.find(b._sanitizeSelector(j.hash)).html(n);
              b._cleanup();
              h.cache && a.data(j, "cache.tabs", true);
              b._trigger("load", null, b._ui(b.anchors[i], b.panels[i]));
              try {
                h.ajaxOptions.success(n, k);
              } catch (m) {}
            },
            error: function (n, k) {
              b._cleanup();
